 ...
 * the ACTION_MANAGE_NETWORK_USAGE action. This activity provides a preferences UI
 * for users to specify network preferences to control data usage.
 */
public class QuizSettingsActivity extends PreferenceActivity
        implements
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        // activity, the display refreshes to reflect the new preferences.
